...
RELEVANCE_HOOK: 1 sentence. Why this specific article is relevant to the mandate. Be precise — name the specific connection (the priority intelligence target, strategic positioning, current design challenges, etc.). If it is not relevant, say so.
