...
const config: InstanceConfig = {
  ...
  mandate: {
    operator: `[PLACEHOLDER] You are the intelligence system for the Lilly Direct engagement. The operator context, mandate, and engagement framing will be defined at kickoff and derived from docs/lilly-direct/MANDATE.md. Until then, operate with the shared OS operator profile at docs/os/OPERATOR.md § STRATEGIC DOMAINS § Healthcare and pharma as the baseline context for why Lilly matters to this operator.`,
