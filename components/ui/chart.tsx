...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid items-start gap-1 text-xs",
        className
      )}
      style={{ background: "var(--bg-elevated)", border: "1px solid var(--border)", color: "var(--text-primary)", borderRadius: 10, padding: "12px 14px", boxShadow: "var(--shadow-tooltip)" }}
    >
